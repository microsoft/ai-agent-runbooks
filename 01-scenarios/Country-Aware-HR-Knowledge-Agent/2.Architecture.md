...
**Status:** Available. Configure and validate the components and controls below
for each target tenant; this architecture document does not provision them.
...
not define universal country/global semantics. This runbook defines an explicit
