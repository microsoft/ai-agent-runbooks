...
| Attribute        | Details                                                                                   |
|------------------|-------------------------------------------------------------------------------------------|
| **Agent Name**   | Workplace Agent                                                                           |
| **Category**     | Workforce Productivity / Internal Operations                                              |
...
The agent operates across **three layers**: the user interface, the Copilot Studio agent, and the underlying data and tool layer.
...
flowchart TD
    ...
    subgraph DATA_LAYER["🗄️ Data & Tool Layer"]
        ...
        subgraph ADVANCED["⚡ Advanced Extension (Optional)"]
            D4["Azure AI Search\n(Hybrid / Vector Search)"]
            D5["MCP Server\n(Azure Functions)\nFAQ Search · Ticket API · History Search"]
            D6["Power Platform VNet Support\n(Private Endpoint)"]
        end
    end
    ...
    A4 -. "Advanced: Extended Search via MCP" .-> D5
    D5 -. "Connects via VNet" .-> D4
    D5 -. "Connects via VNet" .-> D6
...
|----------|-------------|
| [2.Architecture.md] | Detailed architecture diagram with component descriptions and data flow. |
| [3.Runbook.md] | Step-by-step setup guide: SharePoint configuration, solution import, environment variables, flow setup, and agent deployment. |
| [4.Sample-Prompts.md] | Sample prompts for end users to get the most out of the agent (inquiries and application scenarios). |
