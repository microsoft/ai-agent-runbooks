...
flowchart TD
    ...
    subgraph BUSINESS_LAYER["🗄️ Business Application & Workflow Layer"]
        D1["Dataverse<br/>Inquiry Ticket<br/>M365 Copilot License Request"]
...
|-----------|------|----------------|
| **Inquiry Ticket** (`mskk_inquiryticket`) | Dataverse table | Stores unresolved internal inquiries, ticket status, inquiry category, inquiry body, AI-generated answer, and final answer. |
| **M365 Copilot License Request** (`mskk_copilotlicenserequest`) | Dataverse table | Stores Microsoft 365 Copilot license request records. |
