...
- [Calendar Request Approval Agent](./01-scenarios/Calendar-Request-Approval-Agent/1.Overview.md) - **Available:** conversational calendar intake, deterministic approval and routing, SharePoint/Outlook publication, and explicit identity and recovery controls.
- [Country-Aware HR Knowledge Agent](./01-scenarios/Country-Aware-HR-Knowledge-Agent/1.Overview.md) - **Available:** country-scoped SharePoint knowledge with organization-wide and optional restricted ingestion lanes, authenticated retrieval, and query-time authorization.
...
- [Chief of Staff Cowork Agent](./01-scenarios/Chief-of-Staff-Cowork-Agent/) — Five configured skills for weekly leadership briefs, stakeholder drafts, review packs and factual team-work visibility, with human review and people-safety boundaries.
- [Recurring Analytics Cowork Agent](./01-scenarios/Recurring-Analytics-Cowork-Agent/) — Six configured skills for Sales, Finance, Retail, Manufacturing and Service reviews from existing Power BI, Fabric or Excel data, with reconciled KPIs and Markdown/HTML outputs.
...
- [Cowork Skill Delivery and Scheduled Reviews](./02-patterns/Cowork-Skill-Delivery-and-Scheduled-Reviews/) — Trusted skill/reference packaging, routing, tenant qualification, controlled sharing, optional scheduled draft preparation and operational handover
- [Governed Analytics Review](./02-patterns/Governed-Analytics-Review/) — Explicit source/KPI contracts, period and numerical reconciliation, RLS and generated-artifact access checks, with consistent narrative and dashboard outputs
